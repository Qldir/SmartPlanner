...
public class PlaceDTO {
	...
	public PlaceDTO(String place_seq, String place_area, String place_name, String place_type, String place_opentime,
			String place_closetime, String place_spendtime, String place_location, String place_detail,
			String place_image, String place_cost, String place_homepage, String place_grade, int place_type_seq,
			int place_type_gender, int place_type_activity, int place_type_restaurant, int place_type_drinking,
			int place_type_majority, int place_type_mania, int place_type_exhibition, int place_type_location,
			double weight) {
		super();
	...
	public String toString() {
		return "PlaceDTO [place_seq=" + place_seq + ", place_area=" + place_area + ", place_name=" + place_name
				...
				+ ", place_homepage=" + place_homepage + ", place_grade=" + place_grade + ", place_type_seq="
				+ place_type_seq + ", place_type_gender=" + place_type_gender + ", place_type_activity="
				+ place_type_activity + ", place_type_restaurant=" + place_type_restaurant + ", place_type_drinking="
				+ place_type_drinking + ", place_type_majority=" + place_type_majority + ", place_type_mania="
				+ place_type_mania + ", place_type_exhibition=" + place_type_exhibition + ", place_type_location="
				+ place_type_location + ", weight=" + weight + "]";
	}
