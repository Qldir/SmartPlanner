...
<body style="overflow-x:hidden;">
	...
	<div class="row justify-content-md-center h-100 pt-5 px-5 mt-2"
		...
		<div class="col-9 p-0">
			<form action="/smartplanner/planbytheme" method="post" id="dataForm">
				<div class="row w-100 m-0 rounded"
					...
					<div class="col-6 bg-primary py-3">
						<div class="row">
							...
							<div class="col-8 mt-3 mb-2">
								<select class="custom-select" id="themeInput" name="plan_theme">
									<option value="-1" selected>テーマを選んでください</option>
									<option value="0">食べ物</option>
									<option value="1">ショッピング</option>
									<option value="2">遺跡</option>
					...
					<div class="col-6 bg-secondary py-3">
						<div class="row">
							<div class="col-3 my-3 p-0 text-right">
								<h4>日付</h4>
							</div>
							...
							<div class="col-3 mt-0 mb-3 pl-3"></div>
							...
							<div class="row w-100 justify-content-md-center pl-4 mt-2">
	...
	<script>
		$(function() {
			...
			$("#submitPlan").on('click', function() {
				...
				var plan_theme = $('#themeInput option:selected').val();
				if (plan_theme == -1) {
					alert("テーマを選択してください");
					return;
				}
