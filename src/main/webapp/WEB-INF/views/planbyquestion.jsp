...
<body style="overflow-x:hidden;">
	...
	<div class="row justify-content-md-center h-100 pt-5 px-5 mt-2"
		...
		<div class="col-12 p-0">
			<form action="/smartplanner/planbyoption" method="post" id="dataForm">
				<div class="row w-100 m-0 rounded"
					...
					<div class="col-12 text-center text-white rounded-top"
						...
						<h2 class="m-2">好みを基にプランニング</h2>
					</div>

					<div class="col-4 bg-light py-3">
						<div class="row">
							<div class="col-3 mt-3 mb-2 p-0 text-right">
								<h5 class="mt-1">タイトル</h5>
							</div>
							<div class="col-8 mt-3 mb-2">
								<input type="text" class="form-control" placeholder="タイトルを入力してください"
									id="titleInput" name="plan_title">
							</div>
							<div class="col-3 mt-1 mb-2 p-0 text-right">
								<h4>地域</h4>
							</div>
							<div class="col-8 mt-1 mb-2">
								<select class="custom-select" id="areaInput" name="place_area">
							...
							<div class="col-8 mt-1 mb-2">
								<div class="input-group">
									<input type="text" class="form-control"
										placeholder="人数を入力してください" id="peopleInput"
										name="plan_peoplecount">
									<div class="input-group-append">
							...
							<div class="col-3 mt-1 mb-0 p-0 text-right">
								<h4>日付</h4>
							</div>
							...
							<div class="col-3 mt-1 mb-0 pl-3"></div>
							<div class="col-8 mt-1 mb-0">
								<div class="input-group">
									<input type="text" class="form-control"
					...
					<div class="col-4 bg-primary py-3">
						<div class="row">
							<div class="col-6 my-3 p-0 text-right">
								<h4>活動</h4>
							</div>
								...
								<div class="row justify-content-md-center">
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										<label class="btn btn-info active"> <input
											type="radio" name="place_type_activity" autocomplete="off"
											value="0" checked>嫌い
										</label> <label class="btn btn-info"> <input type="radio"
											name="place_type_activity" autocomplete="off" value="1">好き
										</label>
									</div>
								</div>
							</div>
							...
							<div class="col-6 my-3">
								<div class="row justify-content-md-center">
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										<label class="btn btn-info active"> <input
											type="radio" name="place_type_restaurant" autocomplete="off"
											value="0" checked>嫌い
										</label> <label class="btn btn-info"> <input type="radio"
											name="place_type_restaurant" autocomplete="off" value="1">好き
										</label>
									</div>
								</div>
							</div>
							...
							<div class="col-6 my-3">
								<div class="row justify-content-md-center">
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										<label class="btn btn-info active"> <input
											type="radio" name="place_type_drinking" autocomplete="off"
											value="0" checked>嫌い
										</label> <label class="btn btn-info"> <input type="radio"
											name="place_type_drinking" autocomplete="off" value="1">好き
										</label>
									</div>
								</div>
							</div>
							...
							<div class="col-6 my-3">
								<div class="row justify-content-md-center">
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										<label class="btn btn-info active"> <input
											type="radio" name="place_type_shopping" autocomplete="off"
											value="0" checked>嫌い
										</label> <label class="btn btn-info"> <input type="radio"
											name="place_type_shopping" autocomplete="off" value="1">好き
										</label>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-6 my-3">
								<div class="row justify-content-md-center">
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										<label class="btn btn-info active"> <input
											type="radio" name="place_type_majority" autocomplete="off"
											value="0" checked>嫌い
										</label> <label class="btn btn-info"> <input type="radio"
											name="place_type_majority" autocomplete="off" value="1">好き
										</label>
									</div>
								</div>
							</div>
							...
							<div class="col-6 my-3">
								<div class="row justify-content-md-center">
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										<label class="btn btn-info active"> <input
											type="radio" name="place_type_mania" autocomplete="off"
											value="0" checked>嫌い
										</label> <label class="btn btn-info"> <input type="radio"
											name="place_type_mania" autocomplete="off" value="1">好き
										</label>
									</div>
								</div>
							</div>
							...
							<div class="col-6 my-3">
								<div class="row justify-content-md-center">
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										<label class="btn btn-info active"> <input
											type="radio" name="place_type_exhibition" autocomplete="off"
											value="0" checked>嫌い
										</label> <label class="btn btn-info"> <input type="radio"
											name="place_type_exhibition" autocomplete="off" value="1">好き
										</label>
									</div>
								</div>
							</div>
							
							<div class="row w-100 justify-content-md-center pl-4 mt-1">
			...
			$("#locationSearch")
					.on(
							...
							function() {
								window
										.open(
												"/smartplanner/searchmap",
												"newWindow",
												"width=500px, height=300px, toolbar=no, menubar=no, scrollbars=no, resizable=yes");
							});
