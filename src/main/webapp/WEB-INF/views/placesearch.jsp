...
<body>
 ...
 <div class="text-center py-5 h-50 w-100 mt-4" style="background:url('./resources/img/banner/hujisan.jpg') no-repeat; background-size:cover;">
    <div class="container w-50 h-75" style="background-color:rgba(0,0,0,0.6) !important;">
		<div class="row h-100">
    		...
    		<div class="col-sm-8 h-100" style="display: flex; align-items: center; justify-content: center;">
    			<div class="input-group">
    				<input type="text" class="form-control" placeholder="都市／旅行地を検索してみてください" id="searchInput">
    				<div class="input-group-append">
...
<script>
  ...
  function refreshPagination(){
	...
	function toPagenation(){
		...
		var keyword="${keyword}";
		if(keyword!=""){
			var url="./placesearch?keyword="+keyword+"&page="+pageNum;
		}else{
			var url="./placesearch?page="+pageNum;
		}
